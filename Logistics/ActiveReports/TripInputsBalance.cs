...
namespace Logistics
{
	public partial class TripInputsBalance : DataDynamics.ActiveReports.ActiveReport3
	{
		bool bWeighting = false; 
		public TripInputsBalance()
		{
			InitializeComponent();
		}

		private void TripInputsBalance_FetchData(object sender, FetchEventArgs eArgs)
		{
