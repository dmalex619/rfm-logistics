namespace Logistics
{
	partial class frmActsEdit
	{
        ...
        ((object)(-1))};
			...
			this.dgvcBoxConfirmed.HeaderText = "Коробок";
			...
			this.dgvcBoxConfirmed.ToolTipText = "Коробок";
			...
			this.dgvcQntConfirmed.HeaderText = "Штук";
			...
			this.dgvcQntConfirmed.ToolTipText = "Штук";
			...
			this.chkReadyForWMS.Text = "Акт готов к передаче в складскую систему";
			...
			this.lblDateAct.Text = "Дата акта";
			// 
			// txtOutputID
			// 
			...
			this.lblGoodsStates.Text = "Состояние";
			// 
			// lblOwners
			// 
