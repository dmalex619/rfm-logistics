	...
	public partial class billPerversion : DataDynamics.ActiveReports.ActiveReport3
	{
		...
		private void GroupHeader1_Format(object sender, EventArgs e)
		{
			if (Fields["ContractNumber"].Value.ToString().Length > 0)
				txtGroupHeaderPayerFullName.Text = Fields["PayerFullName"].Value.ToString() + "  Договор " + Fields["ContractNumber"].Value.ToString();
			else
				txtGroupHeaderPayerFullName.Text = Fields["PayerFullName"].Value.ToString(); 
		}
