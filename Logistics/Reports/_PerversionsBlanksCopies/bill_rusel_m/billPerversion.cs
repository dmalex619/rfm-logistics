...
namespace Logistics
{
	public partial class billPerversion : DataDynamics.ActiveReports.ActiveReport3
	{
		...
		private void GroupHeader1_Format(object sender, EventArgs e)
		{
			...
			{
				txtGroupHeaderPayeeName.Text = Fields["PayerFullName"].Value.ToString() + "  Договор " + Fields["ContractNumber"].Value.ToString();
			}
			else
			{
				txtGroupHeaderPayeeName.Text = Fields["PayerFullName"].Value.ToString();
			}
		}
		...
		private void GroupFooter1_Format(object sender, EventArgs e)
		{
			...
			txtGroupFooterNetto.Text = _nOutputDocumentNetto.ToString("# ### ##0.000");
			txtGroupFooterBrutto.Text = _nOutputDocumentBrutto.ToString("# ### ##0.000");
...
private void GroupHeader2_Format()
{
}
...
public void GroupFooter1_Format()
{
	...
	((TextBox)rpt.Sections["GroupFooter1"].Controls["txtGroupFooterNetto"]).Text = _nOutputDocumentNetto.ToString("# ### ##0.000");
	((TextBox)rpt.Sections["GroupFooter1"].Controls["txtGroupFooterBrutto"]).Text = _nOutputDocumentBrutto.ToString("# ### ##0.000");
